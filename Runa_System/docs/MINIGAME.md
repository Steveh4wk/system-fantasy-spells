...
QBCore.Functions.CreateUseableItem('dalgona_sword', function(playerId)
    local Player = QBCore.Functions.GetPlayer(playerId)
    if Player.Functions.RemoveItem('dalgona_sword', 1) then
        TriggerClientEvent('dalgona-game:startMinigameManually', playerId, 'sword', 120)
    end
end)
```
