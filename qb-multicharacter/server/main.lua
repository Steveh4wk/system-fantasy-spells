...
RegisterNetEvent('qb-multicharacter:server:createCharacter', function(data)
    ...
    if QBCore.Player.Login(src, false, newData) then
        ...
        if GetResourceState('qb-apartments') == 'started' and Apartments.Starting then
            ...
            loadHouseData(src)
            TriggerClientEvent('qb-multicharacter:client:closeNUI', src)
            TriggerClientEvent('illenium-appearance:client:CreateFirstCharacter', src, newData, true)
            ...
            loadHouseData(src)
            TriggerClientEvent('qb-multicharacter:client:closeNUI', src)
            TriggerClientEvent('illenium-appearance:client:CreateFirstCharacter', src, newData, false)
            GiveStarterItems(src)
